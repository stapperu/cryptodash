...
const CoinPage = () => {
	...
	return (
		<>
			<div className="bg-gray-800 w-5/6 m-auto h-auto mt-12 p-4 flex flex-col text-center align-middle rounded-3xl">
				{!isLoading && (
					<>
              ...
              <h3 className={`m-12 text-4xl scale-300 ${coin.market_cap_rank===1 ? 'text-yellow-400':'text-amber-100' }`}>#{coin.market_cap_rank}</h3>
